...
eta-key (or Alt-key) always generates a so called "escape sequence", i.e., a
...
-<key> sequences and often introduce their own delay for the ESC key. There is
...
-<key> combination has been pressed. But this also implies that pressing ESC
