...
ovement is restricted to the current line unless CROSSLINES is non-nil.
...
ovement is restricted to the current line unless `evil-cross-lines' is non-nil."
  :type inclusive
  (interactive "<c><C>")
...
(evil-define-command evil-delete-marks (marks &optional force)
  "Delete all marks.
ARKS is a string denoting all marks to be deleted. Mark names are
...
odified version of `reveal-close-old-overlays' from
...
ore precisely, it selects the most recently used buffer that is
