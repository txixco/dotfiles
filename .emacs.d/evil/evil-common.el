...
OTION defaults to the current motion."
...
AP is a keymap for binding KEYS to the wrapper for TARGET.
...
oves point COUNT words forward or (- COUNT) words backward if
...
oves point COUNT symbols forward or (- COUNT) symbols backward
...
oves point COUNT defuns forward or (- COUNT) defuns backward
...
oves point COUNT sentences forward or (- COUNT) sentences
...
oves point COUNT paragraphs forward or (- COUNT) paragraphs backward
...
AGIC is a regexp that matches all potential magic
