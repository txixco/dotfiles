...
AKE        the creation function of the special keymaps.
...
(defcustom evil-default-cursor t
  "The default cursor.
ay be a cursor type as per `cursor-type', a color string as passed
...
ust be readable by `read-kbd-macro'. For example: \"C-z\"."
  :type 'string
  :group 'evil
  :set #'(lambda (sym value)
...
ODE-MAP-ALIST is an alist taking the form of
...
ODES acts as a predicate, containing the symbols of all major or
