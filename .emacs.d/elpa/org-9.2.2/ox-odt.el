...
ore correctly, specify the set of input and output formats that
...
athML.  When invoked as an interactive command, use
`org-latex-regexps' to infer LATEX-FRAG from currently active
region.  If no LaTeX fragments are found, prompt for it.  Push
athML source to kill ring depending on the value of
