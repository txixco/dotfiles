...
IN is the value that will be displayed as empty (zero width bar).
AX is the value that will draw a bar filling all the WIDTH.
...
atching is done by (PREDICATE VAL S), where S is an element of S-LIST.
